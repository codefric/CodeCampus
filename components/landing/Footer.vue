    ...
    <div class="w-full font-arial text-sm font-normal text-center normal-case text-[#333333] bg-[#F5F6F9] p-10">
        <div class="flex items-center justify-between">
            ...
            <div class="grid grid-cols-3 gap-4 text-left">
                ...
                <div>
                    <h3 class="font-semibold mb-4">Popular Courses</h3>
                    <ul class="space-y-3">
                        <li>
                            <a
                                href="#"
                ...
                <!-- Tracks Column -->
                <div>
                    <h3 class="font-semibold mb-4">Tracks</h3>
                    <ul class="space-y-3">
                        <li>
                            <a
                                href="#"
            ...
            <div class="text-left">
                ...
                <p class="text-gray-500 text-xs mb-4">Lorem ipsum dolor sit amet</p>
                <div class="flex flex-col space-y-2">
                    <SharedBaseInput placeholder="Enter your email here" />
                    <SharedBaseButton state="filled">Subscribe</SharedBaseButton>
                </div>
            </div>
        </div>
    </div>
